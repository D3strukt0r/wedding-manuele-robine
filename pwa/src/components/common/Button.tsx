  ...
  return (
    <button
      ...
      className={clsx(
        ...
        props.className,
        {
          'font-noto-sans rounded-lg': layout === 'app-primary',
          'font-semibold rounded-md': layout !== 'app-primary',
          'bg-app-green text-white hover:bg-app-green-dark focus-visible:outline-app-green-dark': !disabled && layout === 'app-primary',
