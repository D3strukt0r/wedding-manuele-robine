...
import Spin from '#/components/common/Spin.tsx';
...
export default function Table({ columns, dataSource, rowKey, isLoading }: TableProps) {
  return (
          ...
          <Spin spinning={isLoading}>
            <table className="min-w-full divide-y divide-gray-300">
              ...
              <tbody className="divide-y divide-gray-200">
                {dataSource.map((data) => (
                  <tr
                    key={typeof rowKey === 'string' ? data[rowKey] : rowKey(data)}
                  >
